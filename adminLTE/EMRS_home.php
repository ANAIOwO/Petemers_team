...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    -->
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="EMRS_home.php" class="nav-link">病歷系統</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="MAS_home.php" class="nav-link">掛號系統</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="PGMS_home.php" class="nav-link">美容管理</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="MMS_home.php" class="nav-link">藥品管理</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="test.html" class="nav-link">首頁</a>
        </li>
        <!--
<<<<nav-item default>>>
